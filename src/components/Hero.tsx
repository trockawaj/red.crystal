            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 h-full flex items-center">
                ...
                <div className="grid grid-cols-12 w-full h-full">
                    ...
                    <div className="col-span-12 md:col-start-5 md:col-span-8 h-full relative">
                        <motion.div
                            className="relative h-[50vh] landscape:h-screen landscape:min-h-[600px] w-full md:h-auto md:absolute md:inset-y-12 md:left-0 md:right-12 overflow-hidden shadow-2xl mt-0 md:mt-0"
