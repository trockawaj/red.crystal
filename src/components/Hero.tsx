        ...
        <section className="relative h-screen w-full overflow-hidden bg-arch-gray flex items-center justify-center">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 h-full flex items-center">
                ...
                <div className="grid grid-cols-12 w-full h-full">
                    ...
                    <div className="col-span-12 landscape:col-span-5 md:landscape:col-span-4 md:col-span-4 flex flex-col justify-center relative z-20 text-black md:text-black">
                        <motion.div
                    ...
                    <div className="col-span-12 landscape:col-span-7 md:landscape:col-span-8 md:col-start-5 md:col-span-8 h-full relative">
                        <motion.div
